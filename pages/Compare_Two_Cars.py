...
if selectt == 'Ford':
    selectt1 = str1.selectbox('Model Name', ['Ecosports', 'Figo',],key=1)
if selectt == 'Honda':
    selectt1 = str1.selectbox('Model Name', ['Amaze', 'City(2014)', 'WR-V'],key=1)
if selectt == 'KIA':
    selectt1 = str1.selectbox('Model Name', ['Carnival'],key=1)

selectt2 = str1.selectbox('City', ['Mumbai','Delhi','Srinagar','Shimla','Vishakhapattnam'],key=1)
selectt4 = str1.selectbox('Fuel', ['Petrol','1.1 Petrol','1.2L Petrol','1.5L Petrol','Diesel','1.4L Diesel','1.5L Diesel','2.2L Diesel'],key=1)
...
if selecttt == 'Honda':
    selecttt1 = str1.selectbox('Model Name.', ['Amaze', 'City(2014)', 'WR-V'],key=2)
if selectt == 'KIA':
